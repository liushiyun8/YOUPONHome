...
/**
 * Created by liuyun on 2017/5/13.
 */
public class ShebeiAdapter extends BaseAdapter {
    Context context;
    List<Devall> list;

    public ShebeiAdapter(Context mContext, List<Devall> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Devall devall = (Devall) getItem(position);
        ...
        switch (devall.getSort()) {
                case 1:
                    ...
                    break;
                case 3:
                    final SubDevice subDevice = (SubDevice) devall;
                    if (subDevice == null)
                        break;
                        ...
                        switch (subDevice.getTp()) {
                            ...
                            case 3:
                                ...
                                if(subDevice.getValue2()!=1){
                                    viewHolder.gaodang.setVisibility(View.VISIBLE);
                                }else viewHolder.gaodang.setVisibility(View.GONE);
                    ...
                    break;
                case 4:
                    final Sensor sensor = (Sensor) devall;
                    if (sensor == null)
                        break;
