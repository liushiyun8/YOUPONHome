...
public class XlinkUtils {
	...
	ConnectivityManager connectivity = (ConnectivityManager) App.ctx
	...
	ConnectivityManager cm = (ConnectivityManager) App.ctx
		.getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	Toast.makeText(App.ctx, tip, Toast.LENGTH_LONG).show();
    }
