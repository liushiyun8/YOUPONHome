...
//    public static String PRODUCTID = "160fa2ad399e9200160fa2ad399e9201";
    public static String PRODUCTID = "160fa6b1b8a903e9160fa6b1b8a93201";
    public static String COMPAYID="100fa6b0ae76c200";

    // ------------启动监听
    public static final String PACKAGE_NAME =App.getApp().getPackageName();
    ...
    public static final String NOTIDATA="notifydata";
