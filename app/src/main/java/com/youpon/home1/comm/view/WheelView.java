...
public class WheelView extends View {  
    ...
    /** 文本的颜色*/     
    private static final int ITEMS_TEXT_COLOR = 0x88FFFFFF;
    ...
    private void initResourcesIfNecessary() {  
        ...
        if (valuePaint == null) {  
            ...
            valuePaint.setTextSize(TEXT_SIZE*1.5f);
...
//        drawShadows(canvas);
    ...
    private void drawCenterRect(Canvas canvas) {  
        ...
        canvas.drawLine(0,center-offset,getWidth(),center-offset,valuePaint);
        canvas.drawLine(0,center + offset,getWidth(),center + offset,valuePaint);
...
//        centerDrawable.draw(canvas);
    ...
    public interface OnWheelScrollListener {
        public void onScrollingStarted(WheelView context);
        public void onScrollingFinished(WheelView context);
    }

    public interface OnWheelChangedListener {
        public void onChanged(WheelView context,int oldValue,int newValue);
    }
}